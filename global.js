  ...
  widget.innerHTML = `
    <div class="fcw__popup" role="menu">
      ...
      <a class="fcw__link fcw__link--zalo" href="https://zalo.me/07816047387" target="_blank" rel="noopener" role="menuitem" aria-label="Chat on Zalo">
        <span class="fcw__link-icon">
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24" rx="4" fill="none"/><path d="M12 3C7.03 3 3 7.03 3 12s4.03 9 9 9 9-4.03 9-9-4.03-9-9-9zm-3.5 6h4.25l-4.5 5H12v1H7.75l4.5-5H9V9zm7 7h-1v-3.5L13 17h-1v-5h1v3.5L15.5 12H16v4z"/></svg>
        </span>
        Zalo
      </a>
      <a class="fcw__link fcw__link--messenger" href="https://m.me/petcarespa" target="_blank" rel="noopener" role="menuitem" aria-label="Chat on Messenger">
        <span class="fcw__link-icon">
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C6.477 2 2 6.145 2 11.259c0 2.86 1.38 5.415 3.55 7.11V21l3.246-1.784a10.6 10.6 0 0 0 3.204.484c5.523 0 10-4.145 10-9.259S17.523 2 12 2zm1.013 12.478-2.548-2.718-4.97 2.718 5.472-5.808 2.61 2.717 4.908-2.717-5.472 5.808z"/></svg>
        </span>
        Messenger
      </a>
    </div>
