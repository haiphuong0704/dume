...
(function () {
  const T = {
    EN: {
      ...
      'svc_page.hero.headline': 'Professional care <em>your pet deserves.</em>',
      'svc_page.hero.body':     'From wellness consultations to luxury grooming, every service is designed around your pet\'s comfort, health and happiness.',
      'svc_page.hero.btn1':     'Book appointment',
      'svc_page.hero.btn2':     'Explore services',
    ...
    VI: {
      ...
      'svc_page.hero.headline': 'Chăm sóc chuyên nghiệp <em>mà thú cưng xứng đáng.</em>',
      'svc_page.hero.body':     'Từ tư vấn sức khỏe đến chải lông cao cấp, mọi dịch vụ đều được thiết kế xung quanh sự thoải mái, sức khỏe và hạnh phúc của thú cưng bạn.',
      'svc_page.hero.btn1':     'Đặt lịch hẹn',
      'svc_page.hero.btn2':     'Khám phá dịch vụ',
